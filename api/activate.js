    ...
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background: #fafafa;">
      ...
      <div style="background: #fff; border: 1px solid #e4e4e7; border-radius: 8px; padding: 20px; margin-bottom: 32px;">
        ...
        <ol style="color: #71717a; padding-left: 20px; line-height: 2; margin: 0;">
          <li>Avaa tilauspalvelun sivu tietokoneella</li>
  ...
  ` : `
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background: #fafafa;">
      ...
      <div style="background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 8px; padding: 16px; margin-bottom: 32px; text-align: center;">
        ...
        <a href="https://juicyflirt.org/download/juicyflirt.zip" style="background: #16a34a; color: #fff; padding: 10px 24px; border-radius: 6px; text-decoration: none; font-size: 14px; font-weight: 600;">Lataa juicyflirt.zip</a>
      </div>
      ...
      <div style="background: #fff; border: 1px solid #e4e4e7; border-radius: 8px; padding: 20px; margin-bottom: 16px;">
        ...
        <ol style="color: #71717a; padding-left: 20px; line-height: 2; margin: 0;">
          ...
          <li>Pura kansio esim. työpöydälle — <strong>älä poista kansiota asennuksen jälkeen!</strong></li>
        </ol>
      </div>

      <div style="background: #fff; border: 1px solid #e4e4e7; border-radius: 8px; padding: 20px; margin-bottom: 16px;">
        <p style="font-weight: 600; color: #09090b; margin-bottom: 4px;">Vaihe 2 — Avaa laajennussivu selaimessasi</p>
        <p style="color: #71717a; font-size: 13px; margin-bottom: 12px;">Valitse käyttämäsi selain:</p>
        <div style="margin-bottom: 12px;">
          <p style="font-weight: 600; color: #09090b; font-size: 13px; margin-bottom: 4px;">🔵 Google Chrome:</p>
          <ol style="color: #71717a; padding-left: 20px; line-height: 2; margin: 0;">
            <li>Kirjoita osoitepalkkiin: <strong style="color: #09090b;">chrome://extensions/</strong> ja paina Enter</li>
            <li>Laita päälle <strong>Kehittäjätila</strong> (Developer mode) — oikeassa yläkulmassa</li>
          </ol>
        </div>
        <div>
          <p style="font-weight: 600; color: #09090b; font-size: 13px; margin-bottom: 4px;">🟦 Microsoft Edge:</p>
          <ol style="color: #71717a; padding-left: 20px; line-height: 2; margin: 0;">
            <li>Kirjoita osoitepalkkiin: <strong style="color: #09090b;">edge://extensions/</strong> ja paina Enter</li>
            <li>Laita päälle <strong>Kehittäjätila</strong> (Developer mode) — vasemmassa alakulmassa</li>
          </ol>
        </div>
      </div>
      ...
      <div style="background: #fff; border: 1px solid #e4e4e7; border-radius: 8px; padding: 20px; margin-bottom: 16px;">
        ...
        <ol style="color: #71717a; padding-left: 20px; line-height: 2; margin: 0;">
          ...
          <li>Valitse purkamasi <strong>juicyflirt</strong>-kansio</li>
      ...
      <div style="background: #fefce8; border: 1px solid #fde047; border-radius: 8px; padding: 16px; margin-bottom: 32px;">
        <p style="color: #854d0e; font-size: 13px; margin: 0;"><strong>⚠️ Tärkeää:</strong> Laajennus toimii vain <strong>tietokoneella Chrome- tai Edge-selaimessa</strong>. Se ei toimi mobiililaitteilla.</p>
      </div>
